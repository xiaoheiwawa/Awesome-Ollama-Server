...
// 检查命令行参数
var runOnce = process.argv.includes('--once');
if (runOnce) {
    // 单次运行模式
    console.log('开始执行单次监控任务...');
    (0, monitor_1.monitorServices)()
        .then(function () {
    ...
    // 立即执行一次
    (0, monitor_1.monitorServices)().catch(function (error) {
        console.error('监控任务失败:', error);
    });
    // 然后每20分钟执行一次
    node_cron_1.default.schedule('*/20 * * * *', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, monitor_1.monitorServices)()];
                case 2:
                    _a.sent();
